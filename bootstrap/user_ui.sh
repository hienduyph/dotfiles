...
_fonts() {
  ...
  cd ${FONT_DIR} && {
    ...
    curl -Lo 'Blex Mono Light Nerd Font Complete.ttf' 'https://github.com/ryanoasis/nerd-fonts/raw/master/patched-fonts/IBMPlexMono/Mono/complete/Blex%20Mono%20Light%20Nerd%20Font%20Complete.ttf'
  cd -; }
}
