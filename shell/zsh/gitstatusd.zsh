...
[[ -f ${HOME}/.znap/gitstatus/gitstatus.prompt.zsh ]] ||
    git clone --depth=1 https://github.com/romkatv/gitstatus.git ${HOME}/.znap/gitstatus

source $HOME/.znap/gitstatus/gitstatus.plugin.zsh
